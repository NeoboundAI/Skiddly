...
const AdminSidebar = () => {
  ...
  const adminNavigationItems = [
    ...
    { name: "Logs", icon: FiFileText, path: "/admin/logs" },
    ...
    >
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="px-4 mb-4">
          {!isCollapsed && (
            <div className="bg-purple-100 text-purple-700 px-3 py-2 rounded-lg text-sm font-medium text-center">
        ...
        <nav className="flex-1 p-4 flex flex-col">
          ...
          {/* Gap of 24px between main and secondary navigation */}
          <div className="mt-6" />
